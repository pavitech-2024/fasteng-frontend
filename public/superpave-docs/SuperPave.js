...
const superPaveApi = {
  ...
  sendVolumetricParametersOfChoosenGranulometryComposition: (data) =>
    ApiBaseURL.post('/superpaveDosage/volumetricParametersOfChoosenGranulometryComposition', data),
  getVolumetricParameters: (id) => ApiBaseURL.get(`/superpaveDosage/volumetricParameters?_id=${id}`),
  getVolumetricParametersOfChoosenGranulometryComposition: (id) =>
    ApiBaseURL.get(`/superpaveDosage/volumetricParametersOfChoosenGranulometryComposition?_id=${id}`),
  getGraphsVolumetricParameters: (id) => ApiBaseURL.get(`/superpaveDosage/graphs?_id=${id}`),
  sendVolumetricParametersOfConfirmGranulometryComposition: (data) =>
    ApiBaseURL.post('/superpaveDosage/volumetricParametersOfConfirmGranulometryComposition', data),
