...
const Igg_GeneralData = ({ nextDisabled, setNextDisabled, igg }: EssayPageProps & { igg: Igg_SERVICE }) => {
  const [loading] = useState<boolean>(false);
  const { generalData, setData } = useIggStore();
...
export default Igg_GeneralData;
