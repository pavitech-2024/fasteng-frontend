...
const Angularity_Step2 = ({ nextDisabled, setNextDisabled }: EssayPageProps) => {
    ...
    if (data.method && data.determinations && data.determinations.length == 0) {
        ...
        if (data.method == 'B') {
            table_data.push({ diameter: t("angularity.diameter-1"), determination: t("angularity.determination-1"), cylinder_mass: null, cylinder_mass_plus_sample: null })
            table_data.push({ diameter: t("angularity.diameter-1"), determination: t("angularity.determination-2"), cylinder_mass: null, cylinder_mass_plus_sample: null })

            table_data.push({ diameter: t("angularity.diameter-2"), determination: t("angularity.determination-1"), cylinder_mass: null, cylinder_mass_plus_sample: null })
            table_data.push({ diameter: t("angularity.diameter-2"), determination: t("angularity.determination-2"), cylinder_mass: null, cylinder_mass_plus_sample: null })

            table_data.push({ diameter: t("angularity.diameter-3"), determination: t("angularity.determination-1"), cylinder_mass: null, cylinder_mass_plus_sample: null })
            table_data.push({ diameter: t("angularity.diameter-3"), determination: t("angularity.determination-2"), cylinder_mass: null, cylinder_mass_plus_sample: null })
        } else {
            table_data.push({ diameter: "-", determination: t("angularity.determination-1"), cylinder_mass: null, cylinder_mass_plus_sample: null })
            table_data.push({ diameter: "-", determination: t("angularity.determination-2"), cylinder_mass: null, cylinder_mass_plus_sample: null })
        }
    ...
    const columns: GridColDef[] = [
        ...
        },
        {
            ...
            renderCell: ({ row }) => {
                ...
                const determination_index = rows.findIndex((r) => data.method === 'B' ? r.determination === determination && r.diameter === diameter : r.determination === determination);
    ...
    if (nextDisabled && data.relative_density && data.cylinder_volume && data.method)
