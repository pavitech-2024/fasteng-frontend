...
const SoilsGranulometry_Step2 = ({ nextDisabled, setNextDisabled }: EssayPageProps) => {
  ...
  return (
    <Box>
      ...
      {rows?.length > 0 && columns?.length > 0 && <SoilsGranulometry_step2Table rows={rows} columns={columns} />}
      <Box
        sx={{
          width: '100%',
          display: 'grid',
...
export default SoilsGranulometry_Step2;
