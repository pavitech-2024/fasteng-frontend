...
const GranulometryMateriaView = ({ granulometryData }: IGranulometryMateriaView) => {
  ...
  if (granulometryData) {
    data.container_other_data.push(
      ...
      { label: t('granulometry-concrete.nominal-diameter'), value: granulometryData.results.nominal_diameter, unity: 'mm' },
      { label: t('granulometry-concrete.fineness-module'), value: granulometryData.results.fineness_module, unity: '%' },
