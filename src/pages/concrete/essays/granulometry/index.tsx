...
import useConcreteGranulometryStore, { ConcreteGranulometryActions } from '@/stores/concrete/granulometry/granulometry.store';
...
const ConcreteGranulometry = () => {
  ...
  const granulometry = new ConcreteGranulometry_SERVICE();
  ...
  const store = useConcreteGranulometryStore();

  // set the userId to the service
  granulometry.userId = userId;

  // set the store to the service
  granulometry.store_actions = store as ConcreteGranulometryActions;
