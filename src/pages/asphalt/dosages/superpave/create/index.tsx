...
const Superpave = () => {
  ...
  const childrens = [
    ...
    { step: 2, children: <Superpave_Step4 superpave={superpave} />, data: store },
    { step: 3, children: <Superpave_Step5 superpave={superpave} />, data: store },
    { step: 4, children: <Superpave_Step6 superpave={superpave} />, data: store },
    { step: 5, children: <Superpave_Step7 superpave={superpave} />, data: store },
    { step: 6, children: <Superpave_Step8 superpave={superpave} />, data: store },
    { step: 7, children: <Superpave_Step9 superpave={superpave} />, data: store },
    { step: 8, children: <Superpave_Step10 superpave={superpave} />, data: store },
    { step: 9, children: <Superpave_Step11 superpave={superpave} />, data: store },
    { step: 10, children: <Superpave_Step12 superpave={superpave} />, data: store },
    { step: 11, children: <Superpave_Step13 superpave={superpave} />, data: store },
  ];
