        ...
        >
          ...
          >
            ...
            >
              ...
              <Typography sx={{ marginBottom: '1rem' }}>{t('pm.fwd.works.register')}</Typography>
              <Box
                sx={{
                  position: 'absolute',
                  top: '2vh',
              ...
              <Typography sx={{ marginTop: '2rem', marginBottom: '1rem' }}>{t('pm.fwd.works.view')}</Typography>
              <Box
                sx={{
                  position: 'absolute',
                  top: '2vh',
            ...
            if (isRegister) {
              return (
                <div
                  key={option.name}
                  onClick={() => {
                    useFWDStore.getState().resetStore();
