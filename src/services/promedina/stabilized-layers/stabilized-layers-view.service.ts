...
const samplesService = {
  ...
  saveSample: (sampleData: StabilizedLayersData) => Api.post(`promedina/stabilized-layers/stabilized-layers-samples/save`, sampleData),
  ...
  updateSample: (sampleId: string, sampleData: StabilizedLayersData) => Api.put(`promedina/stabilized-layers/stabilized-layers-samples/${sampleId}`, sampleData),
