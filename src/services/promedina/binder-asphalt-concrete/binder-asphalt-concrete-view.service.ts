...
const samplesService = {
  ...
  saveSample: (sampleData: BinderAsphaltConcreteData) => Api.post(`promedina/binder-asphalt-concrete/binder-asphalt-concrete-samples/save`, sampleData),
  ...
  updateSample: (sampleId: string, sampleData: BinderAsphaltConcreteData) => Api.put(`promedina/binder-asphalt-concrete/binder-asphalt-concrete-samples/${sampleId}`, sampleData),
